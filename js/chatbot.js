    ...
    const faqDatabase = {
        auth: {
            ...
            questions: [
                ...
                { id: 'q5', icon: 'lock', text: '🔒 האם הנתונים המחקריים שלי מאובטחים במערכת, ומי רשאי לגשת אליהם?', answer: 'אבטחת המידע במערכת תוכננה מראש בקפידה וברמה הגבוהה ביותר, תוך השקעת מאמץ מחשבתי רב בכיסוי כל תרחיש אפשרי ומקרי קצה. המערכת פועלת במודל הרשאות מחמיר הנאכף ישירות בשרת הנתונים, כך שגישה למידע, לקבצים ולרשימות המשתמשים מתאפשרת אך ורק למורשים שאושרו פרטנית על ידי הנהלת המיזם. חסמנו הרמטית כל וקטור תקיפה או אפשרות לגישה עקיפה – גם במקרה שבו גורם חיצוני ינסה להירשם למערכת בדרכים עוקפות או לזייף הרשאות, הוא יישאר חסום לחלוטין וללא יכולת לשאוב מידע. בנוסף, מיושם בידוד נתונים (Data Isolation) מוחלט: כל חוקר או חקלאי חשוף אך ורק לניסויים שהוא הקים או לכאלו ששותפו איתו מפורשות, מה שמבטיח שמירה מלאה על סודיות המחקר שלך.' }
            ]
        },
        dashboard: {
