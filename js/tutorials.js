...
const VIDEOS = [
    {
        ...
        desc: 'יצירת ניסוי חדש בלחיצת כפתור פלוס ומתן שם לניסוי. מילוי פרטי הניסוי, חיפוש שותפים רשומים במערכת, הגדרת מטרות ותקציר הניסוי, קביעת מספר טיפולים וחזרות, מתן שם לכל טיפול לצורך זיהוי, הגדרת משתנים עם רמות, הוספת אבני דרך מרכזיות ויצירת מפת מחקר הזמינה בכל רגע.'
    },
    {
        id: 'AzX2yNuZ5Qw',
        num: '02',
        title: 'הכנות לניסוי',
        desc: 'הזנת נתוני ההכנות לניסוי דרך לשוניות טיפולים עם אפשרות להעתקה אוטומטית או הזנה נפרדת לכל טיפול. הוספת זנים (אחד או יותר), מועדי הדבקות, הגדרת מבנה הניסוי, נתוני טיפול בקרקע, העלאת קבצים והזנת נתוני טפטוף והשקיה.'
    },
    {
        id: 'HyzCFhUV34M',
        num: '03',
        title: 'מהלך הניסוי',
        desc: 'תיעוד נתוני השקיה ודישון עם אפשרות העלאת קבצים והגדרת תקופת תקף. הזנת מדדי צימוח ונתוני אקלים תוך בחירת סנסור, מיקום ותאריכים. תיעוד פעולות אגרוטכניקה והדברה עם משך פעולה וכמות עובדים, דיווח על מפגעים ספציפיים לניסוי עם תיאור המפגע, תאריך וסוג הטיפול שבוצע.'
    },
    {
        id: 'xJh0ti5OFj8',
        num: '04',
        title: 'תוצאות הניסוי, יומן אירועים וניתוחים פיננסיים',
        desc: 'הזנת תוצאות הניסוי למערכת לפי טיפולים וחזרות, תיעוד נתוני איכויות וכמויות, דיווח על מפגעים ונזקים, ניהול יומן אירועים לתיעוד אירועים חריגים שהתרחשו במהלך הניסוי, והזנת נתונים לניתוחים פיננסיים עם אפשרות השוואת עלויות.'
    }
];
